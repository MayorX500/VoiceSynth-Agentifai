...
config_dataset = BaseDatasetConfig(
    formatter="ljspeech",
    dataset_name="corvo",
    path="../datasets/o_corvo",
    meta_file_train="../datasets/o_corvo/metadata.csv",
    language="pt-pt",
)
...
SPEAKER_REFERENCE = [
    "../inputs/voices/ai-female-voice.wav"  # speaker reference to be used in training test sentences
]
...
def main():
    ...
    config = GPTTrainerConfig(
        ...
        test_sentences=[
            {
                "text": "Levei muito tempo a desenvolver uma voz e agora que a tenho não vou ficar em silêncio.",
                "speaker_wav": SPEAKER_REFERENCE,
                "language": LANGUAGE,
            },
            {
                "text": "Este bolo é ótimo. É tão delicioso e húmido.",
                "speaker_wav": SPEAKER_REFERENCE,
                "language": LANGUAGE,
            },
        ],
